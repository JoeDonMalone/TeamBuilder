const Employee = require('./employee_object');    
...
class Manager extends Employee{
    constructor({name, EID, email, phone, erroneous} = {name:name, EID:EID, email:email, phone:phone, erroneous:erroneous}) {
        ...
        const engineerCard = `
            <div class="card text-white bg-primary mb-5 engineer" style="max-width: 18rem;">
                <div class="name-icon">
                    ...
                    <img src='./Assets/Images/employee-img.png' class = "role-emp-img">
                </div>
...
// var managerObject = new Manager({name: 'Joe Don Malone', EID: '1234', email: 'joe.d.malone@gmail.com', phone:'830-220-0942'});
// console.log(managerObject.createManagerCard());
// console.log(managerObject.getRole());

// // var managerObject = new Manager('data.name', 'data.EID', 'data.email', 'data.phone');
// var engineerObject = new Engineer('Joe Don Malone', '1234', 'joe.d.malone@gmail.com', '830-220-0942');
// console.log(engineerObject.createEngineerCard());
// console.log(engineerObject.getRole());

// // var managerObject = new Manager('data.name', 'data.EID', 'data.email', 'data.phone');
// var internObject = new Intern('Joe Don Malone', '1234', 'joe.d.malone@gmail.com', '830-220-0942');
// console.log(internObject.createInternCard());
// console.log(internObject.getRole());
